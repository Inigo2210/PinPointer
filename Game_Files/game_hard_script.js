//Script for country image guesser hard mode with timer:
...
const countryList = {
	...
	function getCountry() {
		...
		highScore = localStorage.getItem("country_hard_high_score");
		if (highScore == null) {
	...
	function answerTest(ID) {
		...
		document.getElementById("powerUp2").innerHTML = "Get Different Image <br> 40PB";
		...
		if (counter == 11) {
			...
			if ((points > parseInt(localStorage.getItem("country_hard_high_score"))) || (localStorage.getItem("country_hard_high_score") == null)) {
				var newRecord = points.toString(10);
				localStorage.setItem("country_hard_high_score", newRecord);
				document.getElementById("highScore").innerHTML = "Your Best Score: " + localStorage.getItem("country_hard_high_score"); 
			}
		}
		else {
